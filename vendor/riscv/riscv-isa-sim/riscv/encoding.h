...
#define MATCH_SIMDMAX16 0x3000007b
#define MASK_SIMDMAX16 0xfe00707f
#define MATCH_SMAX16 0xca000077
...
DECLARE_INSN(simdmax16, MATCH_SIMDMAX16, MASK_SIMDMAX16)
...
DECLARE_CSR(vec_mode, CSR_VEC_MODE)
